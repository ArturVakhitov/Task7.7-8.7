document.querySelector('#btnBegin').addEventListener('click', function () {
        ...
        if (gameRun){
            if (minValue === maxValue){
                ...
                switch (phraseRandom) {
                    ...
                    case 2:
                        answerPhrase = `Возможно, это`
                        break;

                    case 3:
                        answerPhrase = `Думаю, это число `
                        break;
...
document.querySelector('#btnRetry').addEventListener('click', function () {
    ...
    document.querySelector('.btn-primary').classList.toggle('hidden');
